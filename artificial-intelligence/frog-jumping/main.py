...
# Alma, Ben, and Carl are heading East; while Xavier, Yolanda, and
# Zanjoe are heading West. Each frog can jump just onto an adjacent
# stone, or jump OVER another frog if there is an empty stone behind
# it. The frogs are stubborn, however, and are NOT willing to change
# direction.
